/**
 * Component: TabBreadcrumb
 * Breadcrumb navigation synced with active tab
 */
...
const TabBreadcrumb: React.FC<TabBreadcrumbProps> = ({
  ...
  const handleItemClick = (item: BreadcrumbItem): void => {
    if (item.onClick) {
      item.onClick();
...
/**
 * Hook: useTabBreadcrumb
 * Converts pathname to breadcrumb items
 * 
 * @example
