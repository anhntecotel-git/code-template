 ...
 * Shows dropdown menu for hidden tabs when there are too many tabs
 */
 ...
 * Displays hidden tabs in a dropdown menu
 * Only shows when there are tabs not visible in the scroll area
 */
const TabDropdown: React.FC<TabDropdownProps> = ({
  ...
  // Don't render if all tabs are visible
  ...
  return (
    <div ref={dropdownRef} className="relative">
      <button
        ...
        `}
        aria-label={`Show ${hiddenTabs.length} more tabs`}
